...
include('../config/DbFunction.php');
	...
	if(isset($_POST['submit'])){
     ...
     $obj->register($_POST['course-short'],$_POST['usn'],$_POST['fname'],$_POST['mname'],$_POST['lname'],
     	            $_POST['gname'],$_POST['gender'],$_POST['income'],$_POST['category'],$_POST['ph'],$_POST['nation']
     	             , $_POST['mobno'],$_POST['email'],$_POST['country'],$_POST['state'],$_POST['padd'],
...
<option VALUE="">SELECT</option>
	 ...
	 <br><br>								
			...
			<div class="form-group">
		<div class="col-lg-4">
		<label>Sem<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<br><br>	
			...
			<div class="col-lg-4">
			<input class="form-control" type="text" name="usn" required="required" maxlength="10">
			</div>
			</div>	
	<br><br>
			<div class="form-group">
...
<option VALUE="">Select Country</option>
   ...
   <option VALUE="<?php echo htmlentities($res->id);?>"><?php echo htmlentities($res->name)?></option>
			...
			<div class="col-lg-4">
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="">
	...
	<br><br><br><br>		
			...
			<div class="col-lg-4">
           <select name="city" id="dist"  class="form-control" onchange="" required="">
      ...
      <textarea class="form-control" rows="3" name="cadd"  id="cadd"></textarea>
        ...
        <div class="row">
			...
			<th>&nbsp;&nbsp;&nbsp;&nbsp;CET/MGMT</th>
              ...
              <div class="col-lg-6">
			 <th>&nbsp;&nbsp;&nbsp;&nbsp;CET_NO(if mgmt give NA)</th>
			</div>                                 
             <div class="col-lg-6">
			   <th>&nbsp;&nbsp;&nbsp;&nbsp;RANK(if mgmt give NA)</th>
			</div>                               
                                        </tr>
                                    </thead>
                                    <tbody>
